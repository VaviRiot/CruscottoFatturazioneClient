...
export class WizardFormStepComponent implements OnInit, OnDestroy {
  private _hidden = false;
  @Input() title: string;
  @Input() showNext = true;
  @Input() showPrev = true;
  @Input() showCustomSave = false;
  @Input() validStep: boolean = true;

  @Output() onNext: EventEmitter<any> = new EventEmitter<any>();
  @Output() onPrev: EventEmitter<any> = new EventEmitter<any>();
  @Output() onCustomSave: EventEmitter<any> = new EventEmitter<any>();
