...
export class DashboardComponent implements OnInit {
  ...
  public topSummary = new DashboardTopSummary(0,new Date(), 0, '', 0, '', 0, new Date());
  ...
  loadDashboard()
  {
      ...
      this.myDashClientiSubscription = this.dashService.getDashboardClientiAttivi(authToken, this.defIdRole, this.defIsAdmin, this.defAdminView, this.defSelectedBusiness).subscribe(res => {
      ...
      this.myTopSubscription = this.dashService.getTopSummary(authToken, this.defIdRole, this.defIsAdmin, this.defAdminView, this.defSelectedBusiness).subscribe(res =>{
      ...
      error => {
         ...
         this.topSummary = {
          firstBoxValue: 5376,
          firstBoxDetail: moment().toDate(),
          secondBoxValue:2663,
          secondBoxDetail: '2671',
          thirdBoxValue:3,
          thirdBoxDetail: '300000',
          fourthBoxValue: 80.150000,
          fourthBoxDetail: moment().toDate()
        }
